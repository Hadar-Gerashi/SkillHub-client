...
import FeaturesCourse from '../../component/course/FeaturesCourse';
import CourseCarousel from '../../component/course/CourseCarousel';
import './HomePage.css';
        ...
        <div className="home-page">
            <header className="hero-section">
                <div className="overlay">
                    <h1 className="animate_title">Upgrade Your Knowledge</h1>
                    <p className="animate" >Transform your career with expert-led courses in various fields.</p>
